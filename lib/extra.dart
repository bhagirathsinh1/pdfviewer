...
//   deleteDialougeRecentScreen(BuildContext context, snapshot, index) {
//     // set up the buttons
...
//   deleteMethodRecentScreen(BuildContext context, snapshot, index) async {
//     await RecentSQLPDFService().removeFromRecent(
//         snapshot.data![index].pdf.toString(), SqlModel.tableRecent);
//     deleteFileRecent(
//       File(
...
//   showAlertDialogRecent(BuildContext context, snapshot, index) {
//     // set up the button
