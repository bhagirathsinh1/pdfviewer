...
import 'package:pdfviewer/widget/rename_files.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer<PdfFileService>(builder: (context, counter, child) {
      return ListView.builder(
        ...
        itemCount:
            Provider.of<PdfFileService>(context, listen: false).files.length,
        itemBuilder: (BuildContext ctxt, index) {
          ...
          return Card(
            child: ListTile(
              title: Text(Provider.of<PdfFileService>(context, listen: false)
                  .files[index]
                  .path
                  .split('/')
                  .last),
